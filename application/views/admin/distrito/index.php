<div id="app">
        ...
        <a href="<?php echo base_url();?>administracion/aula/eliminar" onClick="return confirm('Desea Dar de Baja el Aula?')" class="btn btn-danger btn-sm"><span class="fas fa-fw fa-trash-alt"></span></a>
